...
about: Probiotici kroz hranu i crevna flora
image: /wp-content/uploads/2024/03/crevna.flora.hero.jpg
og_image: /wp-content/uploads/2024/03/crevna.flora.og.jpg
card_image: /wp-content/uploads/2024/03/crevna.flora.kartica.jpg
categories:
  - zdravlje
tags:
  - crevna flora
  ...
  - zdravlje
item_list:
  - name: Fermentisani mlečni proizvodi
    description: Jogurt, kefir, kiselo mleko i pavlaka — žive kulture koje svakodnevno dopunjuju floru.
  - name: Kiseljeno povrće
    description: Kiseli kupus, krastavci i turšija — Lactobacillus iz domaće zimnice bez pasteurizacije.
  - name: Pasulj i vlakna
    description: Leguminoze i povrće hrane dobre bakterije — prebiotici koji drže probiotike na poslu.
  - name: Domaća zimnica
    description: Sezonska priprema fermentisane hrane — navika koja Balkan već vekovima neguje.
sections:
  - name: Crevna flora u kratkim crtama
    id: crevna-flora-u-kratkim-crtama
  - name: Probiotici kroz hranu
    id: probiotici-kroz-hranu
    items:
      - name: Fermentisani mlečni proizvodi
        id: fermentisani-mlecni-proizvodi
      - name: Kiseljeno povrće
        id: kiseljeno-povrce
      - name: Pasulj i vlakna
        id: pasulj-i-vlakna
      - name: Domaća zimnica
        id: domaca-zimnica
  - name: Prebiotici — hrana za dobre bakterije
    id: prebiotici
  - name: Navike koje podržavaju creva
    id: navike-koje-podrzavaju-creva
  - name: Suplementi i lekar
    id: suplementi-i-lekar
  - name: Zaključak
    id: zakljucak
---
...
## Crevna flora u kratkim crtama {#crevna-flora-u-kratkim-crtama}
...
## Probiotici kroz hranu {#probiotici-kroz-hranu}
...
Za uvod u nauku iza veze hrane i creva pogledajte [kratko edukativno objašnjenje na YouTube-u](https://www.youtube.com/watch?v=BVb0Xn30uH8){:rel="nofollow"} — kako obrok menja sastav bakterija u crevima već u prvim satima.

### Fermentisani mlečni proizvodi {#fermentisani-mlecni-proizvodi}
...
1. **Jogurt** — birajte proizvod sa oznakom „žive kulture“; termički tretirani jogurti posle pakovanja nemaju aktivan probiotički efekat. U kuhinji: [salata od patlidžana sa jogurtom](/salata-od-patlidzana-sa-jogurtom/) ili [kolač sa jogurtom i orasima](/kolač-sa-jogurtom-i-orasima/) koriste jogurt hladno, pa kulture ostaju aktivne.
2. **Kiselo mleko** — blažeg ukusa od jogurta, pogodno uz [projice sa kiselom pavlakom](/projice-sa-kiselom-pavlakom/) ili [tikvice sa kiselim mlekom](/tikvice-sa-kiselim-mlekom/). Puna čaša uz obrok povrća donosi i kalcijum i probiotike.
...
### Kiseljeno povrće {#kiseljeno-povrce}
...
1. **Kiseli kupus** — klasičan zimski izvor probiotika i vitamina C. Koristite ga u [piti od kiselog kupusa](/pita-od-kiselog-kupusa/), [musaki od kiselog kupusa](/musaka-od-kiselog-kupusa/) ili [kiflama sa kiselim kupusom](/kifle-sa-kiselim-kupusom/) — ali **dodajte kupus na kraju** ili kuvajte kratko, da se kultura delimično sačuva u svežem prilogu.
2. **Kiseli krastavčići** — recept [kiselih krastavčića](/kiseli-krastavčići/) na Superkuvaru koristi prirodno kiseljenje; uz obrok od [čorbastog pasulja](/čorbast-pasulj/) dobijate i probiotike i prebiotike u istom tanjiru.
3. **Turšija i kiseli paradajz** — [kiseli zeleni paradajz](/kiseli-zeleni-paradajz/) i mešavine povrća u tegli; pazite da tegla „diše“ pri fermentaciji i da povrće ostane potopljeno u salamuri.
...
### Pasulj i vlakna {#pasulj-i-vlakna}
...
1. **Pasulj** — [čorbast pasulj](/čorbast-pasulj/), [pasulj sa koprivom](/pasulj-sa-koprivom/) ili [vegetarijanski pasulj](/vegetarijanski-pasulj/) kombinuju vlakna leguminoza sa povrćem; jedan obrok nedeljno značajno podiže unos rastvorljivih vlakana.
2. **Kupus i kiselica** — [kupusnik](/kupusnik/), [dinstani kupus](/dinstani-kupus/) i sveže [salate od kupusa](/salata-od-kupusa-sa-orasima/) dopunjuju fermentisanu zimnicu svežim vlaknima.
3. **Integralno žito** — [živo žito](/zivo-zito/) (posno jelo od pšeničnog žita) i integralni hlebovi sa semenkama podržavaju sporije varenje i stabilniju glukozu — indirektno pogoduju i crevima.
...
2. **Domaći ajvar** — [domaći ajvar](/domaci-ajvar/) i [ajvar sa renom](/ajvar-sa-renom/) nisu izvor živih kultura, ali uz kiseli prilog čine obrok bogatijim antioksidansima i vlaknima.
...
4. **Inspiracija za tanjir** — kombinacije kiselog i svežeg povrća često se dele i na [Pinterest-u](https://www.pinterest.com/search/pins/?q=fermented%20foods%20healthy%20gut){:rel="nofollow"} kao ideje za fermentisane obroke — korisno za vizuelne predloge serviranja.

## Prebiotici — hrana za dobre bakterije {#prebiotici}
...
| Topla čorba od povrća | Hidratacija + vlakna — npr. [corba od koprive](/corba-od-koprive/) ili [corba od pecuraka](/corba-od-pecuraka/) |
...
## Navike koje podržavaju creva {#navike-koje-podrzavaju-creva}
...
6. **Deljenje iskustava** — mnoge porodice i dalje razmenjuju recepte za kiseljenje i mlečne proizvode; zajednice poput [NutritionFacts na Facebook-u](https://www.facebook.com/nutritionfacts.org){:rel="nofollow"} nude proverene, naučno utemeljene tekstove o ishrani i crevima (na engleskom, ali korisno za dodatno čitanje).
...
## Suplementi i lekar {#suplementi-i-lekar}
...
Suplement **ne zamenjuje** fermentisanu hranu dugoročno — hrana donosi matricu vlakana, minerala i enzima. Za vitamine B i apsorpciju u crevima važna je i celokupna slika probave, slično onome što opisujemo u vezi [niacina i flore](/naicin/).

## Zaključak {#zakljucak}

Zdrava crevna flora gradi se tanjir po tanjir: **žive kulture** iz jogurta i kiselog mleka, **fermentisano povrće** iz tegle, **vlakna** iz pasulja i kupusa, i **navike** koje ne razaraju ono što hrana gradi. Na Balkanu već imate polovinu alata u ostavi i u tradiciji — Superkuvar recepti poput [kiselih krastavčića](/kiseli-krastavčići/), [čorbastog pasulja](/čorbast-pasulj/) i [pite od kiselog kupusa](/pita-od-kiselog-kupusa/) pokazuju kako to izgleda u praksi, ne samo u teoriji.
...
**Napomena:** Kombinujte ovaj vodič sa člancima [4 tipa vitamina C](/4-tipa-vitamina-c/) i [silicijum za kosti i sudove](/silicijum/) kada želite celokupniju sliku ishrane i suplemenata.